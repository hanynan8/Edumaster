...
export default function AssignmentSubmissionsPage({ params }) {
  ...
  const STATUS_LABELS = {
    submitted: { label: t.statusSubmitted, cls: "bg-[#EBEFF6] text-[#003A91]" },
              ...
              <div key={s.id} className="bg-white rounded-2xl border border-gray-200 p-5">
                ...
                {s.fileUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-sm font-semibold text-[#003A91] hover:underline mb-3"
                  >
                ...
                <div className="grid sm:grid-cols-[120px_1fr_auto] gap-3 items-start pt-3 border-t border-gray-100">
                  <input
                    ...
                    className="border border-gray-300 rounded-xl px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-[#5279B4]"
                    value={draft.score}
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 bg-[#003A91] text-white text-sm font-semibold px-4 py-2 rounded-xl hover:bg-[#002E74] disabled:opacity-60"
                  >
