    ...
    >
      <div className="max-w-lg mx-auto">
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
          <div className={`h-1.5 ${isValid ? "bg-gradient-to-r from-[#0a0a0a] to-[#1D6FD8]" : "bg-red-400"}`} />
            ...
            {isValid && cert && (
              <div className="text-start space-y-3 bg-gray-50 rounded-xl p-5 mb-6">
                <div className="flex items-center gap-3">
                  <Award size={16} className="text-[#1D6FD8] shrink-0" />
                ...
                <div className="flex items-center gap-3">
                  <BookOpen size={16} className="text-[#1D6FD8] shrink-0" />
                  <div className="min-w-0">
                ...
                <div className="flex items-center gap-3">
                  <Calendar size={16} className="text-[#1D6FD8] shrink-0" />
                  <div className="min-w-0">
                ...
                <div className="flex items-center gap-3">
                  <Hash size={16} className="text-[#1D6FD8] shrink-0" />
                  <div className="min-w-0">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              {!isValid && (
                <>
                  ...
                  <Link href="/courses" className="text-sm font-semibold text-[#1D6FD8] hover:underline">
                    {t.browse}
                  </Link>
                </>
              )}
