...
function Blocked({ t }) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 text-center px-6">
      ...
      <Link href="/" className="text-[#0f2d57] font-semibold hover:underline">
        {t.backHome}
      </Link>
    </div>
  );
...
function getPhaseMeta(t) {
  return {
    ...
    upcoming: { label: t.phaseUpcoming, className: "bg-[#d9dde4] text-[#0c2547]" },
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <input
              type="url"
              className="w-full border border-gray-300 rounded-xl px-4 py-2.5 outline-none focus:ring-2 focus:ring-[#5c708d] dir-ltr text-left"
              value={form.link}
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-5 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between gap-3 mb-3">
        <div className="flex items-center gap-1.5 text-xs font-semibold text-[#0f2d57] bg-[#eceef2] px-2.5 py-1 rounded-full">
      ...
      <div className="flex items-center gap-2">
        {phase === "ended" ? (
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-[#0f2d57] to-[#0f2d57] text-white text-sm font-semibold py-2.5 rounded-xl hover:opacity-90"
          >
        ...
        {canManage && (
          <>
            <button
              ...
              title={t.editTitle}
              className="w-10 h-10 flex items-center justify-center rounded-xl border border-gray-200 text-gray-500 hover:border-[#5c708d] hover:text-[#0f2d57]"
            >
              <Pencil size={15} />
            </button>
            <button
  ...
  if (status === "loading") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <Loader className="animate-spin text-[#314a6f]" size={40} />
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex items-center justify-between flex-wrap gap-4 mb-8">
          <div className="flex items-center gap-3">
            <Link
              href={dashboardHref}
              className="w-10 h-10 flex items-center justify-center rounded-xl border border-gray-200 text-gray-500 hover:border-[#5c708d] hover:text-[#0f2d57] bg-white"
              title={t.back}
            >
              <ArrowRight size={18} />
            </Link>
          ...
          {canCreate && (
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-[#0f2d57] to-[#0f2d57] text-white font-semibold px-5 py-2.5 rounded-xl hover:opacity-90"
            >
