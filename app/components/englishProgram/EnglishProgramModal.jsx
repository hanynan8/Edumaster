...
// app/components/englishProgram/EnglishProgramModal.jsx
//
// نافذة منبثقة (modal) بتلف <EnglishProgramForm /> عشان تتفتح من أي مكان في
// الموقع (صفحة الخدمات، الهوم لوج-إن/لوج-أوت) من غير ما نحتاج صفحة منفصلة.
// نفس نمط ConsultationModal / TranslationModal بالظبط.

import { useEffect } from "react";
import { useLanguage } from "@/contexts/LanguageContext";
import { X } from "lucide-react";
import EnglishProgramForm from "./EnglishProgramForm";

export default function EnglishProgramModal({ open, onClose }) {
