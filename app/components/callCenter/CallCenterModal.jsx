...
// app/components/callCenter/CallCenterModal.jsx
//
// نافذة منبثقة (modal) بتلف <CallCenterForm /> عشان تتفتح من صفحة الخدمات
// (خدمة الـ Call Center) من غير ما نحتاج صفحة منفصلة.
// نفس نمط EnglishProgramModal / ScholarshipModal بالظبط.
