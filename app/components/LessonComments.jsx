    ...
    <div className="mt-4 pt-4 border-t border-gray-100">
      ...
      <form onSubmit={submitQuestion} className="flex items-center gap-2 mb-4">
        <input
          ...
          maxLength={2000}
          className="flex-1 text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-[#003A91]"
        />
        <button
          type="submit"
          disabled={posting || !newQuestion.trim()}
          className="shrink-0 bg-[#003A91] text-white p-2 rounded-lg hover:opacity-90 disabled:opacity-50 transition-opacity"
          aria-label={t.send}
        >
          <Send size={15} />
        </button>
              ...
              {replyOpenFor === c.id ? (
                <div className="mt-2 ms-4 flex items-center gap-2">
                  <input
                    ...
                    maxLength={2000}
                    className="flex-1 text-xs border border-gray-200 rounded-lg px-3 py-1.5 focus:outline-none focus:border-[#003A91]"
                  />
                  <button onClick={() => submitReply(c.id)} className="text-xs font-semibold text-[#003A91] shrink-0">
                    {t.send}
                  </button>
                </div>
              ) : (
                <button
                  ...
                  className="mt-2 ms-4 text-[11px] font-semibold text-gray-400 hover:text-[#003A91] transition-colors"
                >
                  {t.reply}
                </button>
              )}
