...
//
// 🅿️ GETPAYIN مؤقتًا متوقف (الحساب لسه مش مفعّل عند GetPayIn) — بدالها
// بيانات تحويل بنكي بتتعرض هنا للمستخدم، ومطلوب منه يبعت سكرين شوت التحويل
// على واتساب لتفعيل الكورس/الاشتراك يدويًا من الإدارة.
//
// لما يتفعّل حساب GetPayIn: رجّع GETPAYIN_ENABLED في PaymentGatewayModal.jsx
