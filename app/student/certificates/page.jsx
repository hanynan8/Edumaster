...
function CertificateCard({ cert, t, isRTL }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg transition-shadow">
      <div className="relative h-32 bg-gradient-to-br from-[#0a0a0a] to-[#003A91] flex items-center justify-center">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 text-xs font-semibold bg-[#003A91] text-white px-3 py-2.5 rounded-xl hover:bg-[#002E74] transition-colors disabled:opacity-60"
          >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        ...
        {certificates?.length === 0 && (
          <div className="bg-white rounded-2xl border-2 border-dashed border-gray-200 py-16 text-center">
            ...
            <Link href="/courses" className="inline-flex items-center gap-1.5 text-[#003A91] font-semibold hover:underline">
