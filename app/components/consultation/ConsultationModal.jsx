...
// app/components/consultation/ConsultationModal.jsx
//
// نافذة منبثقة (modal) بتلف <ConsultationForm /> عشان تتفتح من أي مكان في
// الموقع (صفحة الخدمات، الهوم لوج-إن/لوج-أوت) من غير ما نحتاج صفحة منفصلة.
// بتتقفل بزرار الإغلاق، الدوس بره النافذة، أو زرار Escape.
