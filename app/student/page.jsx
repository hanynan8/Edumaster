  ...
  if (!membership || !membership.plan || membership.status === "inactive") {
    return (
      <div className="bg-white rounded-2xl border border-gray-100 p-5 flex items-center justify-between flex-wrap gap-3">
        ...
        <Link href="/membership" className="text-sm font-semibold text-[#003A91] hover:underline">
          {t.viewPlans}
        </Link>
      </div>
    );
  ...
  return (
    <div
      className={`rounded-2xl border p-5 flex items-center justify-between flex-wrap gap-4 ${
        isActive ? "bg-gradient-to-r from-[#0a0a0a] to-[#003A91] text-white border-transparent" : "bg-white border-gray-100"
      }`}
    >
      <div className="flex items-center gap-3">
...
function SummaryStats({ enrollments, certificatesCount, t }) {
  ...
  const cards = [
    { icon: TrendingUp, label: t.summaryProgress, value: `${avgProgress}%`, accent: "bg-[#EBEFF6] text-[#003A91]" },
    ...
    { icon: Award, label: t.summaryCertificates, value: certificatesCount, accent: "bg-[#EBEFF6] text-[#003A91]", link: "/student/certificates" },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        ...
        {enrollments?.length === 0 && (
          <div className="bg-white rounded-2xl border-2 border-dashed border-gray-200 py-16 text-center">
            ...
            <Link href="/courses" className="text-[#003A91] font-semibold hover:underline">
              {t.browse}
            </Link>
          </div>
        )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {enrollments.map((e) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="text-sm font-semibold text-gray-800 line-clamp-2 mb-2 group-hover:text-[#003A91] transition-colors">
                    {e.courseTitle || "—"}
                  </h3>
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    {e.status === "completed" ? (
                      ...
                      <span className="flex items-center gap-1 text-[#003A91] font-semibold">
