...
const courseSchema = new mongoose.Schema(
  {
    ...
    // 🆕 اختبار "قيّم مستواك" (ClassMarker) — اختياري تمامًا. المدرس/الأدمن
    // هو اللي بيحط الـ quiz ID ده من ClassMarker (https://www.classmarker.com/)
    // وقت إنشاء/تعديل الكورس. وجود قيمة هنا هو نفسه "العلامة المميزة" اللي
    // بتفرّق الكورسات اللي المفروض يظهر فيها اختبار قبل التسجيل (غالبًا
    // كورسات اللغة، لكن مش مقفولة على تصنيف معيّن — أي كورس ممكن يتحط له
    // اختبار لو المدرس عايز كده) عن باقي الكورسات العادية. لو فاضي، مفيش
    // اختبار بيظهر خالص في صفحة تفاصيل الكورس.
    classMarkerQuizId: { type: String, default: "", trim: true, maxlength: 100 },
