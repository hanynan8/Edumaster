        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              {TYPES.map((tp) => (
                <button
                  ...
                  className={`flex-1 py-2 rounded-xl text-sm font-semibold border ${
                    type === tp.value ? "bg-[#003A91] text-white border-[#003A91]" : "border-gray-300 text-gray-600 hover:bg-gray-50"
                  }`}
                >
                  {tp.label}
                </button>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              {type === "multiple_choice" && options.length < 6 && (
                <button type="button" onClick={addOption} className="flex items-center gap-1 text-xs font-semibold text-[#003A91] hover:underline">
              ...
              {options.map((o, idx) => (
                <div key={idx} className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 border border-gray-300 rounded-xl px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-[#5279B4] disabled:bg-gray-50 disabled:text-gray-500"
          ...
          <div>
            ...
            <input
              ...
              min={0}
              step={0.5}
              className="w-32 border border-gray-300 rounded-xl px-4 py-2.5 outline-none focus:ring-2 focus:ring-[#5279B4]"
              value={points}
